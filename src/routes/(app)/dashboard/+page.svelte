							...
							<div class="flex items-center">
								...
								<div class="ml-5 w-0 flex-1">
									<dl>
										...
										<dd class="text-lg font-medium text-gray-900">
											<a href="/blog/new" class="text-indigo-600 hover:text-indigo-500">
												Create Article
											</a>
										</dd>
									</dl>
						...
						<div class="flex items-center">
							...
							<div class="ml-5 w-0 flex-1">
								<dl>
									...
									<dd class="text-lg font-medium text-gray-900">
										<a href="/children/new" class="text-green-600 hover:text-green-500">
											Add Child
										</a>
									</dd>
								</dl>
						...
						<div class="flex items-center">
							...
							<div class="ml-5 w-0 flex-1">
								<dl>
									...
									<dd class="text-lg font-medium text-gray-900">
										<a href="/blog" class="text-gray-600 hover:text-gray-500">
											Browse All
										</a>
									</dd>
								</dl>
